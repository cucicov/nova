    ...
    $(function() {
        ...
        const translations = {
            ...
            "en": {
                ...
                "text-main-space-and-spatiality": "Art installations as a multi-sensory experiential artistic practice will deliberately blur the boundaries between form and function. One of their unifying functions is to redefine and re-organize space. \n" +
                    "<br/><br/>\n" +
                    "Unlike art forms such as painting and sculptural objects, which may be considered Fine Art, installation art directly influences how a viewer perceives their surroundings. An installation in situ, in three separate places, results in three very distinct and separate visual experiences. The formal and functional qualities of an installation are ultimately affected by the context of the work’s physical setting. \n" +
                    "<br/><br/>\n" +
                    "Installation art as a practice marries concepts of transformation of space, socio-political visual commentary, and the need for human engagement and interaction in order for such works to become “complete.” Many contemporary artists work with spatial elements and the idea of spatiality, not only for the sake of space itself but also as a methodological tool to meet their own artistic needs.\n" +
                    "<br/><br/>\n" +
                    "This presentation explores a few perspectives on how space influences people’s perception of an art installation piece and tries to approach subjects like space as an extension of art installations, why space is essential in design, how we communicate through space, what are the elements through which a space communicates, interactions and space elements with a role in enhancing the immersive experience.",
                "text-main-author-space-and-spatiality": "<b>Iulia Gherghescu</b> is a scenographer, researcher, and associate lecturer at UNATC. Her\n" +
                    "experience includes projects in theatre as a set and costume designer, in film, as a\n" +
                    "space designer for events, and creation of installations dedicated to performance art\n" +
                    "projects. As a designer and researcher, she is interested in the interdisciplinary\n" +
                    "methods of developing transformable and interactive spaces to amplify their\n" +
                    "scenographic potential.",
                "text-main-metaverse-1": "Virtual reality and creating 360 films is becoming rapidly a fundamental part of the film and media entertainment industries. Through this workshop we propose a comprehensive  introduction to VR/360 creation, offering the participants the tools, knowledge and necessary skills to create their own immersive experiences. \n" +
                    "<br/><br/>\n" +
                    "With clear and precise explanations, Marius will walk you through the extensive process of creating real or virtual 360 content, from pre-production to distribution. The content of the course includes, among others: a general presentation of the field of VR/360 creation, terminology, technology, camera selection, camera functioning, positioning of camera and actors, light specs, editing, managing content for VR headsets and online environments. \n" +
                    "<br/><br/>\n" +
                    "The workshop is designed to offer a captivating, yet knowledgeable, practical and technical learning of this novel field. ",
                ...
                "text-main-sound-design": "The sonic world we are immersed into, from our very first moments of life, offers us countless listening experiences, whether active or passive, based on which we establish representations, associations and perceptual expectations. Almost everyone can recognize the sound of a car, the chirping of birds or the sound of sea waves. \n" +
                    "<br/><br/>\n" +
                    "Such perceptual automatisms form the pillars which guide a sound designer when creating the sound of a movie, a game or an installation. However, things are different when a sound designer creates the sound of abstract, imaginary worlds that have no correspondence to the real world. \n" +
                    "<br/><br/>\n" +
                    "How would a black hole sound? How would two interacting geometrical shapes sound? What inspires a sound designer facing such challenges? In which degree can he take certain sonic associations from the real world in order to create an imaginary world? The workshop aims for a discussion starting with these questions, while also trying to offer a few potential approaches in the practice of sound design for imaginary worlds.\n",
                ...
                "text-main-style-gan": "StyleGAN is a deep learning model used to generate images in a latent space obtained by training on a certain type of images (e.g. portraits, landscapes, photos with animals etc).  Even though in the last two years text-to-image models (DALL-E, Midjourney, Stable Diffusion…) have captured the spotlight, StyleGAN models remain attractive for a fluid exploration of space. These types of applications (latent walk, projection), controlled in real time, are the subject of this workshop. \n" +
                    "<br/><br/>\n" +
                    "The workshop is open for anyone, but experience with Python, PyTorch, Google Colab etc will be useful for the practical part.",
                "text-main-author-style-gan": "<b>Grigore Burloiu</b> is a lecturer in the Animation and Interactivity department of UNATC, where he coordinates the master’s degree program Interactive Technologies in Performing and Media Arts (ITPMA). There, he teaches creative coding and interactive musical instruments. \n" +
                    "<br/><br/>\n" +
                    ...
                    "<br/>Academic: <a href=\"https://orcid.org/0000-0002-9059-9621 \">https://orcid.org/0000-0002-9059-9621 </a><br/>\n" +
                    ...
                    "Email: grigore.burloiu@unatc.ro <br/>",
                "text-main-deep-learning": "GPT-3 from OpenAI is the most famous and powerful generative model of NLP (natural language processing), but one can obtain impressive results also with smaller models, derived from GPT-2. The latter carry the advantage that we can train them on our own datasets (collections of texts), then place them in the desired contexts. \n" +
                    "<br/><br/>\n" +
                    "In this workshop I will demonstrate how I created, based on a set of speculative texts, a chatbot / oracle that responds to the user’s questions about the future. You can use the same principles to create your own interactive text situations. \n" +
                    "<br/><br/>\n" +
                    "Coding knowledge is not necessary. However, a basic understanding of deep learning and the Google Colab environment are welcomed.\n" +
                    "\n",
                ...
                "text-main-author-zimmt": "<b>ZiMMT</b> provides the appropriate stage for the many facets of media immersion and a place for creative experimentation. As one of only a few cultural institutions, ZIMMT has an innovative 3D audio system consisting of 36 loudspeakers. This offers the opportunity to develop and present immersive, space-consuming concerts, exhibitions and performances. In addition to the interdisciplinary exchange of artists and developers, the center is particularly interested in the transfer of knowledge and workshops. ZiMMT is a gallery, production space, concert hall, research lab and network all in one.\n" +
                    "<br/><br/>\n" +
                    "ZiMMT 3D Sound Lab is an experience offered by IQOS.\n" +
                    "<br/><br/>\n" +
                ...
                "text-main-nova-talks": "<br/><br/>Through this event, NOVA proposes a marathon of inspiration and creates the context for fascinating discussions about the importance of new technologies in the creative process and in exploring human cognitive potential.\n" +
                    "<br/><br/>\n" +
                    "Thus, on November 26, at Cinema Elvira Popescu, the public will meet and interact with 6 speakers, including researchers, but also artists whose works are included in the main exhibition.\n" +
                    "<br/><br/>\n" +
            ...
            "ro": {
                ...
                "text-main-space-and-spatiality": "Instalațiile de artă ca practică artistică experiențială multisenzorială vor estompa în mod deliberat granițele dintre formă și funcție. Una dintre funcțiile lor unificatoare este redefinirea și reorganizarea spațiului.\n" +
                    "<br/><br/>\n" +
                    "Spre deosebire de formele de artă plastică bidimensionale, cum ar fi pictură și obiectele sculpturale, instalațiile influențează direct modul în care un spectator percepe mediul înconjurător și invers. O instalație în situ, în trei locuri separate, are ca rezultat trei experiențe vizuale foarte distincte și separate. Calitățile formale și funcționale ale unei instalații sunt în cele din urmă afectate de contextul cadrului fizic al lucrării. \n" +
                    "<br/><br/>\n" +
                    "Instalația ca practică îmbină conceptele de transformare a spațiului, comentariul vizual socio-politic și nevoia de implicare și interacțiune umană pentru ca astfel de lucrări să devină „complete”. Mulți artiști contemporani lucrează cu elemente spațiale și ideea de spațialitate, nu numai de dragul spațiului în sine, ci și folosindu-l ca instrument metodologic pentru a-și satisface propriile nevoi artistice.\n" +
                    "<br/><br/>\n" +
                    "Această prezentare explorează câteva perspective despre modul în care spațiul influențează percepția oamenilor asupra unei piese de instalație de artă și abordează subiecte precum spațiul ca o extensie a instalațiilor de artă, de ce spațiul este esențial în design, cum comunicăm prin spațiu, care sunt elementele prin care un spațiu comunică, interacțiunea și elemente spațiale care amplifică experiența imersivă.",
                "text-main-author-space-and-spatiality": "<b>Iulia Gherghescu</b> este scenograf, cercetător și lector asociat în cadrul UNATC.\n" +
                    "Experiența sa cuprinde proiecte în teatru ca designer de décor si costume, in film, ca\n" +
                    "designer de spațiu pentru evenimente și creație de instalații pentru proiecte de\n" +
                    "performance art. Ca designer și în cercetare este interesată de metodele\n" +
                    "interdisciplinare de dezvoltare de spații transformabile și interactive pentru amplificarea\n" +
                    "potențialul lor scenografic.",
                ...
                "text-main-metaverse-2": "A collective, virtual space, created through the convergence of physical and virtual reality, improved objects and spaces. The Metaverse promises large scale, persistent environments so that users can share experiences at the intersection between the physical and the digital. If we are to have a 3D digital world, we’ll have to fill it with things, and not just a handful. We’ll need sufficient 3D objects so that we can create a rich, vibrant world, full of digital items that mirror the physical reality we are used to. \n" +
                    "<br/><br/>\n" +
                    "This workshop presents a method to transpose real objects into the metaverse using photogrammetry. Through this technique we extract 2D information from photos and then process it to obtain a 3D object. \n",
                "text-main-sound-design": "Lumea sonoră în care suntem imersați încă din primele momente de viață ne oferă nenumărate experiențe de ascultare, active sau pasive, pe baza cărora ne formăm reprezentări, asocieri și așteptări perceptuale. Aproape oricine poate recunoaște sunetul unei mașini, ciripitul unor păsări sau sunetul produs de valurile mării. \n" +
                    "<br/><br/>\n" +
                    "Astfel de automatisme perceptuale constituie pilonii care ghidează un sound designer atunci când realizează sunetul unui film, al unui joc, sau a unei instalații. Lucrurile, însă, stau diferit atunci când un sound designer concepe sunetul unor lumi abstracte, imaginare, fără corespondent în lumea reală. \n" +
                    "<br/><br/>\n" +
                    "Cum ar putea suna o gaură neagră? Dar două figuri geometrice care interacționează? Pe ce se bazează un sound designer în fața unor astfel de provocări? În ce măsură poate prelua anumite asocieri sonore din lumea reală pentru a crea o lume imaginară? Workshopul își propune să pornească o discuție pe baza acestor întrebări, încercând să ofere și câteva potențiale abordări în practica de sound design pentru astfel de lumi imaginare.",
                ...
                "text-main-style-gan": "StyleGAN este un model deep learning pentru generare de imagini într-un anumit spațiu latent obținut din antrenarea pe o anumită categorie de imagini (e.g. portrete, peisaje, poze cu animale etc). Chiar dacă în ultimii 1-2 ani atenția a fost captată de modelele text-to-image (DALL-E, Midjourney, Stable Diffusion…), modelele tip StyleGAN rămân atractive pentru explorarea fluidă a spațiului. Acest fel de aplicații (latent walk, projection), controlate în timp real, fac subiectul acestui workshop.\n" +
                    "<br/><br/>\n" +
                    "Workshop-ul este deschis oricui dar experiența cu Python, PyTorch, Google Colab etc va fi utilă pentru partea practică.",
                "text-main-author-style-gan": "<b>Grigore Burloiu</b> este lector în departamentul Animație și Interactivitate al UNATC, unde coordonează programul de master Tehnologii interactive pentru arte performative și media (ITPMA), în cadrul căruia predă programare creativă și sisteme muzicale interactive.\n" +
                    ...
                    "Code: <a href=\"https://github.com/rvirmoors\">https://github.com/rvirmoors</a> <br/>\n" +
                    "Email: grigore.burloiu@unatc.ro <br/>",
                "text-main-deep-learning": "GPT-3 de la OpenAI este cel mai faimos și puternic model generativ de NLP (natural language processing), dar rezultate impresionante pot fi obținute și din modele mai mici, derivate din GPT-2. Acestea din urmă au avantajul că le putem antrena pe propriile dataset-uri (colecții de texte), urmând ca apoi să le plasăm în situații dorite de noi.\n" +
                    "<br/><br/>\n" +
                    "În acest workshop voi demonstra cum am creat un chatbot / oracol care răspunde la întrebările user-ului despre viitor bazat pe un set de texte speculative. Puteți folosi aceleași principii pentru a vă crea propriile situații textuale interactive.\n" +
                    "<br/><br/>\n" +
                    "Nu sunt necesare cunoștințe de programare. Noțiuni de bază despre deep learning și mediul Google Colab sunt binevenite însă.",
                ...
                "text-main-author-zimmt": "<b>ZiMMT</b> este o galerie, un spațiu de producție multimedia, o sală de concerte, un laborator de cercetare și o rețea de artiști și profesioniști care susțin inovația. Centrul oferă o platformă deosebită pentru diverse aplicații artistice imersive și experimente creative. Este una dintre puținele instituții culturale dotate cu un sistem audio 3D inovator format din 36 de difuzoare. Acesta permite dezvoltarea și prezentarea unor concerte imersive, care învăluie întregul spațiu, expoziții și performance-uri inedite. Pe lângă schimbul interdisciplinar dintre artiști și dezvoltatori, centrul se focusează în mod particular pe activități educaționale.\n" +
                    "<br/><br/>\n" +
                    "ZiMMT 3D Sound Lab este o experiență oferită de IQOS.\n" +
                    "<br/><br/>\n" +
                ...
                "text-main-nova-talks": "<br/><br/>Prin acest eveniment, NOVA propune un maraton al inspirației și creează contextul unor discuții fascinante despre importanța noilor tehnologii în procesul creativ și în explorarea potențialul cognitiv uman. \n" +
                    "Astfel, în 26 noiembrie, la Cinema Elvira Popescu, publicul va cunoaște și va interacționa cu 6 speakeri, printre care se numără cercetători, dar și artiști ale căror lucrări sunt incluse în expoziția principală. \n" +
                    ...
                    "<br/><br/>\n" +
                    "Temele de discuție vor aluneca ușor de la roboți la neuroștiință, de la storytelling la spiritualitarea inteligenței artificiale și la rolul acesteia în reconstruirea propriilor amintiri, de la cunoașterea sinelui conștient și inconștient până la conectarea profundă cu mediul înconjurător cu ajutorul tehnologiei. \n" +
                    "<br/><br/>\n" +
