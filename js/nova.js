        ...
        const translations = {
            ...
            "text-main-intuition": "A sky of possibilities is also a cosmos of choices. How do we shape ourselves through what we choose? Is there a hidden pattern? <br/><br/>\n" +
                ...
                "text-main-nova-talks": "<br/><br/>Through this event, NOVA proposes a marathon of inspiration and creates the context for fascinating discussions about the importance of new technologies in the creative process and in exploring human cognitive potential.\n" +
                    "<br/><br/>\n" +
                    "Thus, on November 26, at Cinema Elvire Popescu, the public will meet and interact with 6 speakers, including researchers, but also artists whose works are included in the main exhibition.\n" +
                    "<br/><br/>\n" +
            ...
            "ro": {
                ...
                "text-main-author-space-and-spatiality": "<b>Iulia Gherghescu</b> este scenograf, cercetător și lector asociat în cadrul UNATC.\n" +
                    "Experiența sa cuprinde proiecte în teatru, ca designer de décor si costume, în film, ca\n" +
                ...
                "text-main-metaverse-1": "Realitatea virtuală și realizarea de filme 360 devine rapid o parte fundamentală a industriilor de film și media entertainment. Propunem o introducere în creația de VR/360 cu un atelier cuprinzător, care oferă participanților instrumentele, cunoștințele și abilitățile necesare pentru a-și crea propriile experiențe imersive. Pe parcursul cursului, voi oferi o explicație clară și precisă a procesului de realizare a conținutului 360 real sau virtual, de la pre-producție până la distribuție. Conținutul cursului include, dar nu se limitează la prezentarea generală a VR/360, terminologie, tehnologie, selecția camerei, funcționarea camerei, poziționarea camerei și a actorilor, iluminare, editare, stăpânire conținut pentru căștile de VR și online. Acest atelier este conceput pentru a oferi o abordare tehnică, captivantă și practică a învățării acestui nou mediu.\n",
                ...
                "text-main-sound-design": "Lumea sonoră în care suntem imersați încă din primele momente de viață ne oferă nenumărate experiențe de ascultare, active sau pasive, pe baza cărora ne formăm reprezentări, asocieri și așteptări perceptuale. Aproape oricine poate recunoaște sunetul unei mașini, ciripitul unor păsări sau sunetul produs de valurile mării. \n" +
                    "<br/><br/>\n" +
                    "Astfel de automatisme perceptuale constituie pilonii care ghidează un sound designer atunci când realizează sunetul unui film, al unui joc sau al unei instalații. Lucrurile, însă, stau diferit atunci când un sound designer concepe sunetul unor lumi abstracte, imaginare, fără corespondent în lumea reală. \n" +
                    "<br/><br/>\n" +
                ...
                "text-main-style-gan": "StyleGAN este un model deep learning pentru generare de imagini într-un anumit spațiu latent obținut din antrenarea pe o anumită categorie de imagini (e.g. portrete, peisaje, poze cu animale etc). Chiar dacă în ultimii 1-2 ani atenția a fost captată de modelele text-to-image (DALL-E, Midjourney, Stable Diffusion…), modelele tip StyleGAN rămân atractive pentru explorarea fluidă a spațiului. Acest fel de aplicații (latent walk, projection), controlate în timp real, fac subiectul acestui workshop.\n" +
                    "<br/><br/>\n" +
                    "Workshopul este deschis oricui, dar experiența cu Python, PyTorch, Google Colab etc. va fi utilă pentru partea practică.",
                ...
                "text-main-nova-talks": "<br/><br/>Prin acest eveniment, NOVA propune un maraton al inspirației și creează contextul unor discuții fascinante despre importanța noilor tehnologii în procesul creativ și în explorarea potențialul cognitiv uman. \n" +
                    "Astfel, în 26 noiembrie, la Cinema Elvire Popescu, publicul va cunoaște și va interacționa cu 6 speakeri, printre care se numără cercetători, dar și artiști ale căror lucrări sunt incluse în expoziția principală. \n" +
